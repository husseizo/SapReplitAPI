...
- [Gate Warehouse Bin Pick](gate-warehouse-bin-pick.md) — Select Bin & Pick + 4-check closure COMPLETE 2026-09-18; WB01-WB18 + WC01-WC20 passing; commit 77c2129 on master; live SAP gate (409), DesiredFinalPickQty semantics, 207 contract
